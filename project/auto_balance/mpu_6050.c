...
void request_mpu_data(MPU_DATA* data)
{
    ...
    mpu_data.ACC_X = acc_r_temp * data_array[1];
    mpu_data.ACC_Y = acc_r_temp * data_array[2];
    mpu_data.ACC_Z = acc_r_temp * data_array[3];
    mpu_data.TEMP  = data_array[4];
    mpu_data.GYR_X = gyr_r_temp * data_array[5];
    mpu_data.GYR_Y = gyr_r_temp * data_array[6] - 0.9765625f;
    mpu_data.GYR_Z = gyr_r_temp * data_array[0];
